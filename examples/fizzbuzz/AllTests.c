...
extern void Test_Multiples_of_3_are_translated_to_Fizz(CuTest*);
extern void Test_any_multiple_of_3_are_translated_to_Fizz(CuTest*);
extern void Test_Multiples_of_5_are_translated_to_Buzz(CuTest*);
extern void Test_any_multiple_of_5_are_translated_to_Buzz(CuTest*);
extern void Test_number_not_multiple_is_turned_into_its_own_string(CuTest*);
extern void Test_any_number_not_multiple_is_turned_into_its_own_string(CuTest*);
extern void Test_any_number_not_multiple_is_turned_into_its_own_string_case_2(CuTest*);
extern void Test_return_all_fizzBuzz_translations_from_1_to_3 (CuTest*);
extern void Test_return_all_fizzBuzz_translations_from_4_6 (CuTest*);
...
void RunAllTests(void) 
{
    ...
    SUITE_ADD_TEST(suite, Test_any_multiple_of_3_are_translated_to_Fizz);
    SUITE_ADD_TEST(suite, Test_Multiples_of_5_are_translated_to_Buzz);
    SUITE_ADD_TEST(suite, Test_any_multiple_of_5_are_translated_to_Buzz);
    SUITE_ADD_TEST(suite, Test_number_not_multiple_is_turned_into_its_own_string);
    SUITE_ADD_TEST(suite, Test_any_number_not_multiple_is_turned_into_its_own_string);
    SUITE_ADD_TEST(suite, Test_any_number_not_multiple_is_turned_into_its_own_string_case_2);
    SUITE_ADD_TEST(suite, Test_return_all_fizzBuzz_translations_from_1_to_3 );
    SUITE_ADD_TEST(suite, Test_return_all_fizzBuzz_translations_from_4_6 );
